...
protected:
    ...
    std::unordered_map<std::string, std::string> loadTranslations(const std::string &filename);
    void reinsertTranslations(xmlNode *root, const std::unordered_map<std::string, std::string> &translations);
